    ...
    <div className="min-h-screen bg-background text-foreground dark">
      ...
      <div className="relative min-h-screen flex flex-col">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center flex-1 px-6 py-12 text-center">
              ...
              <div className="bg-black rounded-lg px-6 py-3 flex items-center gap-3 min-w-[200px] border border-gray-700">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path
                    ...
                    fill="#EA4335"
                  />
                  <path d="M13.792 12l2.302 2.302-10.937 6.333 8.635-8.635z" fill="#FBBC05" />
                  <path
                    d="M17.293 9.302l2.807 1.626a1 1 0 0 1 0 1.73l-2.808 1.626L15.5 12l2.198-2.491z"
                    fill="#EA4335"
                  />
                  <path d="M5.864 2.658L16.802 8.99 14.5 11.293 5.864 2.658z" fill="#34A853" />
                </svg>
                <div className="text-left">
          ...
          {/* Mobile App Notice */}
          <p className="text-sm text-muted-foreground mt-8 max-w-md">Available exclusively on mobile devices</p>
        </div>
      </div>
    </div>
  )
