...
export const metadata: Metadata = {
  title: "Privacy Policy - DateWallet",
  description: "Privacy Policy for DateWallet mobile application",
};
    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6">
          <p>
            This privacy policy applies to the DateWallet app (hereby referred
            to as "Application") for mobile devices that was created by
            DateWallet (hereby referred to as "Service Provider") as a
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              Phone number. The information that the Service Provider request
          ...
          <section>
            ...
            <p>
              ...
              <a
                href="mailto:davidonyeador@gmail.com"
                className="text-primary hover:underline"
              >
                davidonyeador@gmail.com
              </a>{" "}
